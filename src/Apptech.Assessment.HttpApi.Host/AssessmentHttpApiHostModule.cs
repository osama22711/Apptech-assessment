...
using Apptech.Assessment.HealthChecks;
...
[DependsOn(
    typeof(AssessmentHttpApiModule),
...
public class AssessmentHttpApiHostModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        PreConfigure<OpenIddictBuilder>(builder =>
        {
            ...
            {
                options.AddAudiences("Assessment");
    ...
    private void ConfigureConventionalControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(AssessmentApplicationModule).Assembly);
        });
    }
    ...
    {
        context.Services.AddAssessmentHealthChecks();
    }
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "Assessment API");
