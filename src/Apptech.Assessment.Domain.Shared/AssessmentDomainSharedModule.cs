...
public class AssessmentDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        AssessmentGlobalFeatureConfigurator.Configure();
        AssessmentModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<AssessmentDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<AssessmentResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/Assessment");

            options.DefaultResourceType = typeof(AssessmentResource);
        ...
        {
            options.MapCodeNamespace("Assessment", typeof(AssessmentResource));
        });
    }
}
